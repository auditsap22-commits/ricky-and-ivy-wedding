      ...
      <div className="relative z-20 my-6 sm:my-8 md:my-10 mb-12 sm:mb-16 md:mb-20 px-6 sm:px-10 md:px-12">
        ...
        <div className="text-center mb-8 sm:mb-10 md:mb-12">
          <div className="relative max-w-3xl mx-auto z-20">
            ...
            />
            <div
              className="relative z-20 rounded-xl sm:rounded-2xl border transition-all duration-300 overflow-hidden"
              style={cardStyle}
            >
              <div
              ...
              >
                {getVisibleGuests().map((guest, index) => (
                  <div
                    ...
                    className={`relative z-20 group rounded-xl sm:rounded-2xl p-3.5 sm:p-4 md:p-5 transition-all duration-300 border overflow-hidden hover:shadow-xl ${justEntered ? "animate-guest-roll-in" : ""}`}
                    style={{
                      ...cardStyle,
                      ...(justEntered
                        ? {
        ...
        {confirmedGuests.length === 0 && !isRefreshing && (
          <div className="relative z-20 max-w-xl mx-auto text-center px-4">
            <div className="rounded-xl sm:rounded-2xl border px-6 py-10 sm:py-12" style={cardStyle}>
